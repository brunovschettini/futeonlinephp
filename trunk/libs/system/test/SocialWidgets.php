...
class SocialWidgets {
    ...
    public static function facebookLikeButton($w = 300, $h = 340, $isShowFaces = "true", $isDataStream = "false"){
        ?><div class="fb-like-box" data-href="http://www.facebook.com/<?=FACEBOOK_PROFILE;?>" data-width="<?=$w;?>" data-height="<?=$h;?>" data-show-faces="<?=$isShowFaces;?>" data-stream="<?=$isDataStream;?>" data-header="false"></div><?php
    }
    ...
    */
    ...
    public static function facebookLikeButtonConfig($type = "html5", 
        ...
        if($type == "html5"){
            ...
            echo "Indispon�vel no momento!";
        }
    }
    
    public static function youtubeThumb($codigo = "", $padrao = "default.jpg", $livre = ""){
        ?><img src="http://img.youtube.com/vi/<?=$codigo;?>/<?=$padrao;?>" <?=$livre;?> /><?php
    }
